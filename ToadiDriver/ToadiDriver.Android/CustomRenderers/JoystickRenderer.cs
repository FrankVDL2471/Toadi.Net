...
using ToadiDriver.CustomControls;
using ToadiDriver.Droid.JoystickAndroidCustomControl;
using Xamarin.Forms;
using ToadiDriver.Droid.CustomRenderers;

[assembly: ExportRenderer(typeof(JoystickControl), typeof(JoystickRenderer))]

namespace ToadiDriver.Droid.CustomRenderers {
